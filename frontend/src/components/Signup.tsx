              ...
              <div className="flex flex-wrap gap-3">
                {signupMoods.map((mood) => (
                  <button
                    ...
                    className={`rounded-3xl px-4 py-3 border text-xl transition ${selectedMood === mood ? 'border-blue-600 bg-blue-50 text-blue-700 dark:bg-[rgba(var(--accent-rgb),0.1)] dark:border-blue-400' : 'border-gray-200 bg-white text-gray-700 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-200'}`}
                  >
                    {mood}
                  </button>
                ))}
