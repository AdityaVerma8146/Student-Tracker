...
function LoginPage({ onAuthSuccess, switchToSignup }) {
  ...
  const loginDraft = useAppSelector((state) => state.auth.loginDraft)
        ...
        <div className="grid gap-6 lg:grid-cols-[1.15fr_0.85fr]">
          <section className="rounded-[28px] bg-white p-6 md:p-8">
            <div className="mb-8 flex items-start gap-4">
              <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-blue-600 to-indigo-500 text-white shadow-lg shadow-[0_10px_25px_-5px_rgba(var(--accent-rgb),0.35)]">
                <ShieldCheck size={28} />
              </div>
              <div>
            ...
            <form onSubmit={resetMode ? handlePasswordReset : handleSubmit} className="space-y-5">
              ...
              <button
                ...
                className="inline-flex w-full items-center justify-center gap-2 rounded-2xl bg-gradient-to-r from-blue-600 to-indigo-600 px-5 py-4 text-base font-semibold text-white shadow-lg shadow-[0_10px_25px_-5px_rgba(var(--accent-rgb),0.35)] transition hover:scale-[1.01] hover:from-blue-500 hover:to-indigo-500 disabled:cursor-not-allowed disabled:opacity-70"
              >
