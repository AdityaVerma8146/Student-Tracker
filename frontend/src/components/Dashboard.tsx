...
import { LayoutDashboard, BookOpen, Layers, ListTodo, CheckCircle2, Target } from 'lucide-react'
    ...
    <div className="space-y-8">
      <div className="text-center mb-8">
        <div className="inline-flex items-center gap-2 text-blue-600 dark:text-blue-400 mb-1">
          ...
          <span className="text-xs font-semibold uppercase tracking-[0.3em]">Dashboard</span>
        </div>
        <h1 className="text-4xl font-bold">Study Overview</h1>
        <p className="text-gray-600 dark:text-gray-400 mt-1">Track your learning progress across all subjects</p>
      </div>
            ...
            <div>
              ...
              <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-3">
                <div
                  ...
                  style={{ width: `${completionPercentage}%`, background: 'linear-gradient(90deg, var(--accent-500), var(--accent-400))' }}
                />
              </div>
            </div>
