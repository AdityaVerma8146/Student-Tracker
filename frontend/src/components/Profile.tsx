      ...
      <div className="grid gap-6 lg:grid-cols-[0.9fr_1.1fr]">
        <div className="bg-white dark:bg-gray-800 rounded-3xl p-6 card-shadow flex flex-col items-center text-center">
          <div className="relative">
            <div className="h-32 w-32 rounded-full overflow-hidden border-4 border-blue-100 dark:border-[rgba(var(--accent-rgb),0.2)] bg-blue-600 flex items-center justify-center text-white text-4xl font-semibold">
              {profile?.avatar ? (
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-3xl p-6 card-shadow">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 text-center">
              <div className="rounded-2xl bg-blue-50 dark:bg-[rgba(var(--accent-rgb),0.1)] p-4">
