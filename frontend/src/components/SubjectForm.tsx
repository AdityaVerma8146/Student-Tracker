...
function SubjectForm({ onAddSubject }) {
  ...
  return (
    <div className="bg-gradient-to-r from-blue-500 to-purple-600 rounded-lg p-6 text-white mb-8 card-shadow">
      <h2 className="text-2xl font-bold mb-4 flex items-center gap-2"><Plus size={22} /> Add New Subject</h2>
      <form onSubmit={handleSubmit} className="space-y-3">
        ...
        <button
          type="submit"
          onClick={spawnRipple}
          className="ripple-container w-full flex items-center justify-center gap-2 bg-white text-blue-600 font-bold py-3 rounded-lg hover:bg-gray-100 hover:scale-[1.02] active:scale-[0.98] transition-all"
        >
          <Plus size={20} />
          Add Subject
        </button>
