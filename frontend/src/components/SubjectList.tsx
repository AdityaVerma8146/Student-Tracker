      ...
      {subjects.length === 0 ? (
        ...
        subjects.map((subject, idx) => (
          <div
            ...
            className="stagger-item bg-white dark:bg-gray-800 rounded-lg overflow-hidden card-shadow transition-colors hover:border-[var(--accent-400)] dark:border dark:border-transparent"
          >
            <div
